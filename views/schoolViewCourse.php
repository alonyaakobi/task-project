...
class SchooleViewCourse extends  SimpleView {
    ...
    function set_course_view($course_id){
        ...
        // $StudentInCourseObj = new CourseController();
        // $StudentInCourseObj->getAllStudentInCourse($course_id);
            ...
            $courseArray=$from_sql->getCourseViewInContiner($course_id);
                ...
                foreach($courseArray as $courseNameArray)
                {
                    ...
                    // $StudentArray = $StudentObj->getAllStudents();
                    // foreach ($StudentArray as $Student){
                    //     $StudentImage=  $Student->getStudentImage();
                    //     $StudentName=  $Student->getStudentName();

                        
                    //     echo "<img id='image_continer' src=../".$StudentImage.' /><span>'.$StudentName .'<br>';   
